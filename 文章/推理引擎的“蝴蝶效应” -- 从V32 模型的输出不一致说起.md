...
![attn0 的导出代码](../资源/attn0_dump_code.png)

attn0 的导出代码

![attn1的导出代码](../资源/attn1_dump_code.png)
...
![layer0的 attn0 的结果对比](../资源/attn0_layer_0_compare.png)

layer0的 attn0 的结果对比

![attn1 的 layer0 的输出结果对比](../资源/attn1_layer_0_compare.png)
...
![kvcache 排序后严格相等](../资源/kvcache_sorted_compare.png)
...
![第 61 层的输出对比](../资源/Pasted image 20260120160454.png)

第 61 层的输出对比

此时我们回到 layer7 去查看修改后的 topk 的输出，以及是否存在同分数的情况：

![第 8 层的 topk 对比](../资源/Pasted image 20260120162021.png)
...
![两个一样的 req 的逐层输出结果误差范围对比](../资源/逐层误差区间对比直方图.png)

两个一样的 req 的逐层输出结果误差范围对比
...
## diff_[safetensors.py](http://safetensors.py)

[diff_safetensors](../资源/diff_safetensors.py)

## test_attn_mqa_[determinism.py](http://determinism.py)

[test_attn_mqa_determinism](../资源/test_attn_mqa_determinism.py)