...
# curl - AS
```Shell
curl http://10.178.29.70:80/v2/chat/completions  -H "Content-Type: application/json" -H "Authorization: Bearer bce-v3/ALTAK-seG05tfjoB4V83dl1I60P/df902ea834c2c21559ac5feb3a5720dc175c9733"  -d '{"model": "aiak_bzz2_deepseek_v32_community_rd2", "safety_level":"none", "stream_options": {"include_usage": true}, "max_tokens": 1, "temperature": 0 ,"stream": true, "messages": [{"content":"why we say 42 is the end answer?", "role": "user"}]}'
```
